...
<html>
<head>
<title>이지수 병원(환자 회원가입)</title>
</head>
<script>
function blank_up(){
    //var du = document.docinput;
    var chk1=document.docinput.check1.checked;
    var chk2=document.docinput.check2.checked;
...
<script>
    ...
    var url = "check_doc_id.php?doc_id="+id; 
...
<script>
    ...
    var url = "doc_signup_check_mail.php?doc_email="+emailc; 
...
<form action="doc_signupDo.php" method="post" name="docinput">
...
<hr><p/><br>
   ...
   <input type="text" name="doc_name" id="doc_name" maxlength="20" style="width:220px; height:20px;" required>교수<br><br></div>  

   <div id="name" style="font-size:20px; font-weight:bold;">전공
   <input type="text" name="major" id="major" maxlength="20" style="width:220px; height:20px;" required>과<br><br></div> 
 
   <div id="id" style="font-size:20px; font-weight:bold;">
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;아이디
   <input type="text" name="doc_id" id="doc_id" maxlength="13" style="width:220px; height:20px;" required>
   <input type="button" value="중복확인" name="" onclick="possible()"><br></div>
     <div id="idch">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;의사는 아이디 앞에 "doc_"가 반드시 들어가야 합니다.<input type="hidden" value="0" name="use"><br><br></div>
       
            
   <div id="pw" style="font-size:20px; font-weight:bold;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;비밀번호
   <input type="password" name="doc_password" id="doc_password" maxlength="13" style="width:220px; height:20px;" required><br><br></div>
   
   <div id="pwch" style="font-size:20px; font-weight:bold;">비밀번호확인
   <input type="password" name="pwch" id="pwch" onkeyup="check_pw(this.value)" style="width:220px; height:20px;" required></div>      
   ...
   <input type="text" name="doc_phone" id="doc_phone" maxlength="11" placeholder="ex) 01038509872" style="width:220px; height:20px;" required><br><br></div>

   <div id="email" style="font-size:20px; font-weight:bold;">
   이메일	
   <input type="email" name="doc_email" id="doc_email" maxlength="30" placeholder="ex) aaa@email.com" style="width:220px; height:20px;" required>
