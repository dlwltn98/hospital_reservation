...
<script type="text/javascript">
    function check_Pw() {
      ...
      if(du.doc_password.value != du.pwch.value){
...
<script>
  function check_pw(val){
    ...
    var du = document.pwChange;
    var ogpw = du.doc_password.value;
...
<div class="frame">
     ...
     <form action="my_page_pw_change_doctor_db.php" name="pwChange" method="post">    		
       <div class="new_pw">새로운 비밀번호</div>
       <input type = "password" name = "doc_password" id="doc_password" maxlength="13" style="width:700px; height:80px; position:absolute; left:220px; top:640px;">
