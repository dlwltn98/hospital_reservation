...
<script>
  function mail(){
    ...
    var url = "drop_out_check_mail.php?user_email="+emailc; 
...
<div class="frame">
     ...
     <?php
	   ...
	   <img src="dong.jpg" width="1150px" height="220px">
        ...
        <form action="drop_out_db.php" method="post" name="drop">
          <div class="warn">탈퇴를 위해서는 이메일 인증이 필요합니다.</div>
  
          <div class="mail">이메일</div>     
          <input type="email" name="user_email" id="user_email" maxlength="30" placeholder="ex) aaa@email.com" style="width:700px; height:60px; position:absolute; left:250px; top:660px;">
		  ...
		  <input type="password" name="user_password" id="user_password" maxlength="13" style="width:700px; height:60px; position:absolute; left:250px; top:1005px;">
