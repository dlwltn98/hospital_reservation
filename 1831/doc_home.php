...
<?
$yy = /*$_REQUEST['yy'];*/ $now_year;
$mm = /*$_REQUEST['mm'];*/ $now_month;
...
<td width="130" height="120" align="left" valign="top" bgcolor="#FFFFFF">
  <?
	...
	if (!(($i == 1 && $j < $start_week) || ($i == $total_week && $j > $last_week))){
		...
		// 13. 날자 출력 (날짜 링크 이동)
		?> <div><a href="doc_schedule.php?day=<?=$yy.$mm.$day?>" onClick="window.open(this.href,'', 'width=1100, height=1000, scrollbars=yes'); return false;" style="text-decoration:none;">
		<?echo $day;?></div>
