      ...
      <div class="header-box">
	   ...
	   <img src="dong.jpg" width="1150px" height="220px">
	     ...
	     <div id="nav-box">
      	...
      	<form action="my_page_pw_check_db.php" name="pwChange" method="post">
      	  <div id="pre_pw">현재 비밀번호 : </div> 
      	  <input type = "password" name = "user_password" id="user_password" maxlength="13" style="width:400px; height:40px; position:absolute; left:520px; top:710px;">
