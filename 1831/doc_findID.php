	   ...
	   <img src="dong.jpg" width="1150px" height="220px">
	     ...
	     <div id="nav-box">
           <ul>
            ...
            <form name=frm1 method='post' action='doc_find_chid.php'>
            <div class="f_id1">이메일 : &nbsp;</div>
            <div class="f_id2"><input type=text size=20 name=doc_email style="width:350px; height:45px;"></div>
            <div class="f_id3"><img src="submit.jpg" onclick=id_ch() style="width:150px; heihgt:50px;"></div>
			<div class="f_id4"><img src="findpw.jpg" onclick="location.href='doc_findPW.php'" style="width:150px; heihgt:50px;"></div>
