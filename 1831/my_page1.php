...
<head>
   <meta charset="utf-8">
   <title>my page</title>
   <link rel="stylesheet" type="text/css" href="m_page1.css">
</head>
<body>
...
<div class="frame">
    ...
    <div style="position:absolute; left:450px; top:350px; font-size:50px; font-weight:bold; color:green;">예약 정보</div>
	<div class="contents1" style="position:absolute; left:230px; top:480px;">
	<table>
	...
	<a href="resv_modi_check.php?rtype=change">예약 변경</a>
	<a href="resv_modi_check.php?rtype=delete">예약 취소</a>
      </div>
