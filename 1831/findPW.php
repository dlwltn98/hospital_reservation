	   ...
	   <img src="dong.jpg" width="1150px" height="220px">
	     ...
	     <div id="nav-box">
           <ul>
            ...
            <form name=frm1 method='post' action='find_password_mail.php'>
            <div class="f_pw1">아이디 : &nbsp;</div>
            <div class="f_pw2"><input type=text size=13 name=user_id style="width:350px; height:45px;"></div>
			<form name=frm2 method='post' action='find_pwcheck.php'>
            <div class="f_pw3">이메일 : &nbsp;</div>
            <div class="f_pw4"><input type=text size=30 name=user_email style="width:350px; height:45px;"></div>
			<div class="f_pw5"><img src="submit.jpg" onclick="id_ch()" style="width:150px; heihgt:50px;"></div>
			<div class="f_pw6"><img src="findid.jpg" onclick="location.href='findID.php'" style="width:150px; heihgt:50px;"></div>
			<div class="f_pw7"><img src="main.jpg" onclick="location.href='home.php'" style="width:150px; heihgt:50px;"></div>
            </form>
            <div style="position:absolute; left:460px; top:940px; font-size:20px;">의사 비밀번호 찾기</div>
            <input type=button value="PW찾기" onclick="location.href='doc_findPW.php'" style="position:absolute; left:640px; top:949px;"><br>
